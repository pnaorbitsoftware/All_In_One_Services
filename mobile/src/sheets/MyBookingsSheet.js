...
export default function MyBookingsSheet({
  ...
  const filteredHistory = useMemo(() => {
    ...
    return { completed, providerRejected, clientCancelled };
  }, [bookings]);
          ...
          >
            <View style={styles.historyText}>
              ...
              <Text style={[styles.historyCopy, { color: theme.textMuted }]}>
                {historyCount
                  ? `${filteredHistory.completed.length} completed, ${(filteredHistory.providerRejected.length + filteredHistory.clientCancelled.length)} cancelled/rejected`
