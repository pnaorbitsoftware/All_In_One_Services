...
function validateEnvironment() {
  ...
  if (isProduction && configuredMongoUri.includes("localhost")) {
    throw new Error(
      "MONGO_URI or MONGODB_URI is required for production/Render. Add your MongoDB Atlas connection string in Render Environment."
    );
  }
...
function getMongoConnectionHelp(error) {
  ...
  if (error.message.includes("Invalid scheme")) {
    return [
      ...
      "Fix: MONGO_URI/MONGODB_URI must start with mongodb:// or mongodb+srv://.",
    ];
  }
  ...
  return [
    isAtlasConnection
      ...
      : "Local MongoDB connection failed. Start local MongoDB or switch MONGO_URI/MONGODB_URI to Atlas.",
  ];
}
