...
router.post("/register", async (req, res) => {
  try {
    ...
    const user = await User.create({ name, email, password, role, phone, address: role === "user" ? address : "" });
    registrationOtps.delete(registrationKey);
